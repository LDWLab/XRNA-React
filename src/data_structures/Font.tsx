...
class PartialFont {
  ...
  public static readonly DEFAULT : PartialFont = PartialFont.fromFontId(PartialFont.DEFAULT_FONT_ID);
  ...
  public static toFontId(font : Font) : number {
...
class Font extends PartialFont {
  ...
  public static readonly DEFAULT_SIZE = 8;
  public static readonly DEFAULT = Font.fromPartialFont(PartialFont.DEFAULT, Font.DEFAULT_SIZE);

  constructor(family : string, style : string, weight : string, size : number | string = Font.DEFAULT_SIZE) {
    super(family, style, weight)
    this.size = size;
  }

  public static fromPartialFont(partialFont : PartialFont, size : number | string = Font.DEFAULT_SIZE) : Font {
