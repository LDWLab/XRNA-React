  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '28px', background: theme.colors.backgroundSecondary }}>
        ...
        {/* Grid Section */}
        <PanelContainer title="Canvas Grid" borderRadius={12}>
          <div style={{ 
            display: 'grid', 
            ...
            <div style={{ 
              ...
              <label 
                title={settingsLongDescriptionsMap[Setting.GRID_ENABLED]} 
                style={{ 
              ...
              >
                {settingsShortDescriptionsMap[Setting.GRID_ENABLED]}
              </label>
              <div style={{
                fontSize: '13px',
                color: theme.colors.textWeak || theme.colors.textSecondary,
                ...
                {settingsLongDescriptionsMap[Setting.GRID_ENABLED]}
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <input
                type="checkbox"
                checked={settings[Setting.GRID_ENABLED] as boolean}
                onChange={() => setSettings({ ...settings, [Setting.GRID_ENABLED]: !settings[Setting.GRID_ENABLED] })}
                style={{ 
                  width: '20px', 
                  height: '20px',
            ...
            {/* Grid Type Options - only show when grid is enabled */}
            {settings[Setting.GRID_ENABLED] && (
              <>
                {/* Horizontal Lines */}
                <div style={{ 
                  display: 'flex', 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_HORIZONTAL_LINES]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_HORIZONTAL_LINES]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_HORIZONTAL_LINES]}
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <input
                    type="checkbox"
                    checked={settings[Setting.GRID_HORIZONTAL_LINES] as boolean}
                    onChange={() => setSettings({ ...settings, [Setting.GRID_HORIZONTAL_LINES]: !settings[Setting.GRID_HORIZONTAL_LINES] })}
                    style={{ 
                      width: '20px', 
                      height: '20px',
                      accentColor: theme.colors.primary,
                ...
                <div style={{ 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_VERTICAL_LINES]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_VERTICAL_LINES]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_VERTICAL_LINES]}
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <input
                    type="checkbox"
                    checked={settings[Setting.GRID_VERTICAL_LINES] as boolean}
                    onChange={() => setSettings({ ...settings, [Setting.GRID_VERTICAL_LINES]: !settings[Setting.GRID_VERTICAL_LINES] })}
                    style={{ 
                      width: '20px', 
                      height: '20px',
                      accentColor: theme.colors.primary,
                ...
                <div style={{ 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_LEFT_RIGHT_DIAGONAL]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_LEFT_RIGHT_DIAGONAL]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_LEFT_RIGHT_DIAGONAL]}
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <input
                    type="checkbox"
                    checked={settings[Setting.GRID_LEFT_RIGHT_DIAGONAL] as boolean}
                    onChange={() => setSettings({ ...settings, [Setting.GRID_LEFT_RIGHT_DIAGONAL]: !settings[Setting.GRID_LEFT_RIGHT_DIAGONAL] })}
                    style={{ 
                      width: '20px', 
                      height: '20px',
                      accentColor: theme.colors.primary,
                ...
                <div style={{ 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_RIGHT_LEFT_DIAGONAL]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_RIGHT_LEFT_DIAGONAL]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_RIGHT_LEFT_DIAGONAL]}
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <input
                    type="checkbox"
                    checked={settings[Setting.GRID_RIGHT_LEFT_DIAGONAL] as boolean}
                    onChange={() => setSettings({ ...settings, [Setting.GRID_RIGHT_LEFT_DIAGONAL]: !settings[Setting.GRID_RIGHT_LEFT_DIAGONAL] })}
                    style={{ 
                      width: '20px', 
                      height: '20px',
                      accentColor: theme.colors.primary,
                ...
                <div style={{ 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_CONCENTRIC_CIRCLES]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_CONCENTRIC_CIRCLES]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_CONCENTRIC_CIRCLES]}
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <input
                    type="checkbox"
                    checked={settings[Setting.GRID_CONCENTRIC_CIRCLES] as boolean}
                    onChange={() => setSettings({ ...settings, [Setting.GRID_CONCENTRIC_CIRCLES]: !settings[Setting.GRID_CONCENTRIC_CIRCLES] })}
                    style={{ 
                      width: '20px', 
                      height: '20px',
                      accentColor: theme.colors.primary,
                ...
                <div style={{ 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_SPACING]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_SPACING]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_SPACING]}
                  </div>
                </div>
                <div style={{ minWidth: '200px' }}>
                  <input
                    ...
                    onChange={(e) => setSettings({ ...settings, [Setting.GRID_SPACING]: parseInt(e.target.value) })}
                    style={{
                      width: '100%',
                      height: '6px',
                      borderRadius: '3px',
                  ...
                  <div style={{
                    ...
                    {settings[Setting.GRID_SPACING]}px
                  </div>
                </div>
                ...
                <div style={{ 
                  ...
                  <label 
                    title={settingsLongDescriptionsMap[Setting.GRID_COLOR]} 
                    style={{ 
                      color: theme.colors.textStrong || theme.colors.text, 
                      fontSize: '15px', 
                      fontWeight: '600',
                  ...
                  >
                    {settingsShortDescriptionsMap[Setting.GRID_COLOR]}
                  </label>
                  <div style={{
                    fontSize: '13px',
                    color: theme.colors.textWeak || theme.colors.textSecondary,
                    ...
                    {settingsLongDescriptionsMap[Setting.GRID_COLOR]}
                  </div>
                </div>
                <div style={{ minWidth: '140px' }}>
                  <input
                    type="text"
                    value={settings[Setting.GRID_COLOR] as string}
                    onChange={(e) => setSettings({ ...settings, [Setting.GRID_COLOR]: e.target.value })}
